...
{
    public partial class Manager_Patient_Complaints : Form
    {
        Controller controllerObj;
        public Manager_Patient_Complaints()
        {
            InitializeComponent();
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = controllerObj.receive_complaints_from_patient(year, month, day);
        ...
        private void Manager_Patient_Complaints_Load(object sender, EventArgs e)
        {
            timer1.Start();
